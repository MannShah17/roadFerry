...
//   const tDistanceValue = data.rows[0].elements[0].distance.value;
//   const finalDistanceValue = ((tDistanceValue / 1000) * 10) / 10;
//   return finalDistanceValue.toFixed(2);
// };
...
const fetchDistanceBetweenPoints = async (lat1, lng1, lat2, lng2, selectedVehicleData) => {
    ...
    try {
      ...
      const price = calculatePrice(finalDistanceValue, selectedVehicleData);
